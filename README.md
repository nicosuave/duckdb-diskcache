...
The disk_cache_)hydrate generates io_treads (see disk_cache_config) parallel IO requetsts. Doin so is necessary in cloud instances to get near the network bandwidth, and allows for quick hydration of the smartcache from a previous state.
